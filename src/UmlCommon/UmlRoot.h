...
//
// Description  : Declaration of class UmlRoot.
...
public: // Methods
   void append(UmlElement* elem) override;
   void insert(int pos, UmlElement* elem) override;
   void remove(UmlElement* elem) override;
};
