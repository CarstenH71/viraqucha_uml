...
//
// Description  : Declaration of class UmlTemplateParameter.
...
class UMLCOMMON_EXPORT UmlTemplateParameter : public ISerializable
{
public: // Constructors
   UmlTemplateParameter();
   virtual ~UmlTemplateParameter();
...
public: // Properties:
   ...
   void setConstraints(QString value);
