...
//
// Description  : Declaration of class UmlGeneralization.
...
class UMLCLASSIFIERS_EXPORT UmlGeneralization : public UmlLink, public INamedElement, public IStereotypedElement
{
   ///@cond
   Q_GADGET
...
public: // Constructors
   UmlGeneralization();
   UmlGeneralization(QUuid id);
   virtual ~UmlGeneralization();
