...
//
// Description  : Declaration of class AssociationShape.
...
class AssociationShape : public EdgeShape
{
   typedef EdgeShape super;
public:
   AssociationShape(QGraphicsItem* parent, DiaEdge* edge);
   virtual ~AssociationShape();
...
class AssociationShapeBuilder : public IShapeBuilder
{
public: // Methods
