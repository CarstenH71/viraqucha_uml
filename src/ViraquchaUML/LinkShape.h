...
//
// Description  : Declaration of class LinkShape.
...
class LinkShape : public EdgeShape
{
   typedef EdgeShape super;
public:
   LinkShape(QGraphicsItem* parent, DiaEdge* edge);
   virtual ~LinkShape();
...
class LinkShapeBuilder : public IShapeBuilder
{
public: // Methods
